...
follow = """
{+}-- https://www.facebook.com/DijualGedungDprmurahmeriah
{+}-- https://twitter.com/Gakada
{+}-- https://github.com/HackerMrlinkerrorsystem
{+}-- https://Mrlinkerrorsystem.blogspot.com/in/Manisso
{+}-- https://www.instagram.com/Cyber_Mr_link_error_system_2019
"""
...
\033[91m    }--{+}    Coded By SoloPlayer    {+}--{\033[0m\033[93m|_____|\033[0m                                
       """
  ...
  try:
    ...
    if choice == 1:
	  ...
	  system(reaver)
		...
		os.system("git clone https://github.com/404system/wifisky/")
